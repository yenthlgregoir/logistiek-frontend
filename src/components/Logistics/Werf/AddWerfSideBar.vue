...
<style scoped>
.info-block { display: flex; flex-direction: column; margin-bottom: 15px; }
.info-block label { font-size: 13px; color: #6b7280; margin-bottom: 5px; }
.info-block input { padding: 8px 10px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 14px; }
